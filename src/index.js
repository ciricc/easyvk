...
import Debugger from './utils/debugger.class'
import staticMethods from './utils/staticMethods'
import configuration from './utils/configuration'
import EasyVKRequestsDebugger from './utils/debugger'
import EasyVK, { callbackAPI, version, streamingAPI, is, classes } from './easyvk'
import { AbortController } from './utils/abort'

const debuggerRun = new EasyVKRequestsDebugger(Boolean(false))
